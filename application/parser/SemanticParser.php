...
final class SemanticParser extends Parser
{
    protected $text;
    protected $term;
    protected $parser;
    ...
    {
        $all_terms = require $_SERVER['DOCUMENT_ROOT'] . '/application/semantic/semantic_config/semantic_terms.php';
        ...
        foreach ($arr_text as $text_item) {
            if (FALSE === in_array($text_item, $arr_return)) {
                if (ctype_upper($text_item[0]) AND strlen($text_item) >= 2) {
